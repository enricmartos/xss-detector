...
@SpringBootTest
class XssProcessorServiceImplTest {
    private final XssProcessorService xssProcessor;

    public XssProcessorServiceImplTest() {
        this.xssProcessor = new XssProcessorServiceImpl();
    }
